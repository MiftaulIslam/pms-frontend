...
interface ChatBubbleOvalLeftEllipsisProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  className?: string;
  fill?: string;
  stroke?: string;
...
const ChatBubbleOvalLeftEllipsis: React.FC<ChatBubbleOvalLeftEllipsisProps> = ({
  size = 24,
  className = '',
  fill = 'none',
  stroke = 'currentColor',
